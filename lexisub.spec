...
a = Analysis(
    ['lexisub/main.py'],
    pathex=[],
    binaries=mlx_binaries + mlx_whisper_binaries + mlx_lm_binaries + ffmpeg_binaries,
    datas=[
        ('lexisub/db/schema.sql', 'lexisub/db'),
    ] + mlx_datas + mlx_whisper_datas + mlx_lm_datas + ffmpeg_datas,
    hiddenimports=[
        'lexisub.gui.video_tab',
        'lexisub.gui.glossary_tab',
        'lexisub.gui.main_window',
        'lexisub.gui.pdf_tab',
        'lexisub.gui.subtitle_editor',
        'lexisub.gui.term_edit_dialog',
        'lexisub.gui.styles',
        'loguru',
        'imageio_ffmpeg',
    ] + mlx_hidden + mlx_whisper_hidden + mlx_lm_hidden + ffmpeg_hidden
